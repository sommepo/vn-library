...
class AdapterRegistryTests(unittest.TestCase):
    ...
    def test_gui_records_are_explicit_and_have_unique_game_ids(self):
        ...
        ever17 = gui_adapter('ever17-ps2')
        self.assertEqual(ever17.gui_game_id, 'ever17-slpm65421-1.01')
        self.assertEqual(ever17.preflight_profile, never7.preflight_profile)
        self.assertEqual(ever17.max_unsupported_sites, 0)
        self.assertEqual(len(game_ids), 6)
        cartagra = gui_adapter('cartagra-ps2')
        self.assertEqual(cartagra.gui_game_id, 'cartagra-slpm66231-1.01')
        self.assertEqual(cartagra.max_unsupported_sites, 1)
        self.assertEqual(cartagra.preflight_profile, 'clannad')
